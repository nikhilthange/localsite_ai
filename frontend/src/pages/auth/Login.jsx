    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 via-primary-700 to-primary-900 relative overflow-hidden items-center justify-center">
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-black/10 rounded-full blur-3xl translate-y-1/3 -translate-x-1/4" />
        ...
        >
          ...
          <p className="text-primary-200 text-lg mb-10 leading-relaxed">Continue building amazing websites with AI. Your dashboard is ready for you.</p>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-8 lg:p-16">
        ...
        >
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-[rgb(var(--color-text))] mb-2">Sign in</h1>
            <p className="text-[rgb(var(--color-text-secondary))]">Welcome back! Enter your credentials to continue.</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  aria-label="Password"
                />
                <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-3.5 top-1/2 -translate-y-1/2 text-[rgb(var(--color-text-muted))] hover:text-[rgb(var(--color-text))] transition-colors" aria-label={showPassword ? 'Hide password' : 'Show password'}>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white dark:bg-surface-900 text-[rgb(var(--color-text-muted))]">or continue with</span>
            </div>
          </div>

          <button
            onClick={handleGoogleLogin}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border border-[rgb(var(--color-border))] text-[rgb(var(--color-text))] hover:bg-[rgb(var(--color-surface))] transition-colors font-medium"
          >
